...
for (const calendar of calendars){
  ...
  TemporalHelpers.assertPlainDate(Temporal.PlainDate.from({year: 1955, monthCode: "M07L", day: 30, calendar}).add(p10d), 1955, 9, "M08", 10, "add 10 days from leap day in leap month");
